        ...
        <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
          <div>
            ...
            <div className="flex items-center justify-between text-xs text-stone-600 dark:text-stone-300 mb-1.5">
              <span className="uppercase tracking-wider text-xs font-bold text-rose-600 dark:text-rose-400">
                {product.brand}
              </span>
            ...
            <Link to={`/products/${product.id}`} className="block">
              <h3 className="text-[15px] font-semibold text-stone-950 dark:text-stone-50 hover:text-rose-600 dark:hover:text-rose-400 transition-colors line-clamp-1 leading-snug">
                {product.name}
              </h3>
            </Link>
            ...
            <div className="flex flex-wrap gap-1.5 mt-2.5">
              {keyAttributes.map((attr, idx) => (
                <span
                  key={idx}
                  className="px-2 py-0.5 rounded-md text-xs bg-stone-100 dark:bg-stone-800 text-stone-700 dark:text-stone-300 font-medium"
                >
                  {attr}
                </span>
              ))}
