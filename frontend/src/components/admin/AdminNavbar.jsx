...
import { Moon, Sun, LogOut, ShieldCheck, User } from "lucide-react";
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 pl-3 border-l border-stone-200 dark:border-stone-800">
          ...
          <button
            ...
            className="p-2 rounded-lg text-stone-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/40 transition-colors ml-1"
            title="Sign out"
          >
